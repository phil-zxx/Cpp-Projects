...
#define ADEPT_ACTIVE_STACK adept::_stack_current_thread
  ...
  public:
    ...
    uIndex n_independent() const { return (uIndex) independent_index_.size(); }
    uIndex n_dependent() const { return (uIndex) dependent_index_.size(); }
    ...
    uIndex n_independents() const { return (uIndex) independent_index_.size(); }
    uIndex n_dependents() const { return (uIndex) dependent_index_.size(); }
